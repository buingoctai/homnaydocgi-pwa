...
const Filter = () => {
  ...
  useEffect(() => {
    getAllTopic()
    .then((res: any) => {
      setTopics(res.map((item:string,idx:number) => {
        return {
          key: 'Topic',
          name: item,
          idx
    ...
    getAllAuthor()
    .then((res: any) => {
      setAuthor(res.map((item:string,idx:number) => {
        return {
          key: 'Author',
          name: item,
          idx
        ...
        <div className="article-filter">
          ...
          <div className="option-area">
            ...
            <div className="options">
              ...
              />
              <Button text="Lọc" className='btn__filter' onClick = {() => {
                setFilter({author: ['Tien Long Do'],topic:['Marketing']});
